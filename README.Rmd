...
``` {r,warning=FALSE,message=FALSE, include=FALSE,echo=T}
# Install the package
...
```{r function_mperf_table,warning=FALSE,message=FALSE, fig.width=9,fig.height=0.5,dpi=300, include=FALSE,echo=T}
